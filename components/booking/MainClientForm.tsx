...
export default function MainClientForm({ client, onChange }: MainClientFormProps) {
  ...
  return (
    <div className="lg:col-span-3 bg-luxury-cream rounded-xl p-8 border border-[hsl(var(--color-luxury-gold))]/10 shadow-sm">
      <div className="flex items-center mb-6">
        <div>
          <h3 className="text-2xl font-bold text-luxury-dark">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <label htmlFor="firstName" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <input
            ...
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[hsl(var(--color-luxury-gold))]/90 focus:border-[hsl(var(--color-luxury-gold))]/90 transition-all duration-200 bg-white shadow-sm"
        ...
        {/* Genre */}
        <div>
          <label htmlFor="gender" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <select
            ...
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[hsl(var(--color-luxury-gold))]/90 focus:border-[hsl(var(--color-luxury-gold))]/90 transition-all duration-200 bg-white shadow-sm appearance-none cursor-pointer"
            required
          >
        ...
        {/* Date de naissance */}
        <div>
          <label htmlFor="dateOfBirth" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Nationalité */}
        <div>
          <label htmlFor="nationality" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          <label htmlFor="idType" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          <label htmlFor="idNumber" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Type de client */}
        <div>
          <label htmlFor="customerType" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
            <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {(client.customerType === 'corporate' || client.customerType === 'agency') && (
          <div>
            <label htmlFor="companyName" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
              <svg className="w-4 h-4 mr-1.5 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[hsl(var(--color-luxury-gold))]/90 focus:border-[hsl(var(--color-luxury-gold))]/90 transition-all duration-200 bg-white shadow-sm resize-none"
