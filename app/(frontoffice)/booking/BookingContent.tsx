        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold text-transparent bg-clip-text bg-gray-900 mb-4 tracking-tight">
                        Réservation
                    </h1>
                    ...
                    <div className="px-8 pt-6">
                        ...
                        {success && (
                            <div className="mb-6 p-5 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 rounded-lg shadow-sm">
                                <div className="flex items-center">
                                    <svg className="w-6 h-6 text-gray-700 mr-3 flex-shrink-0 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-md p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                    <div className="flex items-center mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-semibold text-slate-900 mb-1">Dates de séjour</h2>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        ...
                                        <div className="group">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 text-sm font-medium text-slate-900 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all duration-200 shadow-sm hover:border-gray-400 hover:shadow-lg group-hover:bg-white"
                                                required
                                            />
                                        </div>
                                    ...
                                    {/* Info supplémentaire */}
                                    <div className="mt-6 p-4 bg-gray-50 border-l-4 border-blue-500 rounded-lg">
                                        <div className="flex items-start">
                                            <svg className="w-5 h-5 text-gray-700 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <div>
                                                <p className="text-sm font-medium text-blue-900 mb-1">Informations importantes</p>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-md p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                    <div className="flex items-center mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-semibold text-slate-900 mb-1">Nombre de voyageurs</h2>
                                    ...
                                    <div className="max-w-md">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                className="w-full px-3 py-2 text-sm font-medium text-slate-900 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all duration-200 appearance-none cursor-pointer shadow-sm hover:border-gray-400 hover:shadow-lg hover:bg-white"
                                                required
                                            >
                                ...
                                <div className="bg-white rounded-md p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                    <div className="flex items-center mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-semibold text-slate-900 mb-1">Vos informations</h2>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="group">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 text-sm font-medium text-slate-900 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all duration-200 shadow-sm hover:border-gray-400 hover:shadow-lg placeholder:text-slate-400 placeholder:font-normal group-hover:bg-white"
                                                required
                                            />
                                        </div>
                                ...
                                <div className="bg-white rounded-md p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                    <div className="flex items-center mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-semibold text-slate-900 mb-1">Demandes spéciales</h2>
                                            <p className="text-slate-600 font-semibold">Faites-nous part de vos besoins</p>
                                        </div>
                                    </div>

                                    <div className="space-y-4">
                                        <label className="flex items-center text-sm font-medium text-slate-800 tracking-wide">
                                            <svg className="w-4 h-4 mr-2 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <textarea
                                            ...
                                            rows={6}
                                            className="w-full px-3 py-2 text-base font-medium text-slate-900 bg-green-50 border-2 border-green-300 rounded-xl focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all duration-200 resize-none shadow-sm hover:border-gray-400 hover:shadow-lg placeholder:text-slate-400 hover:bg-white"
                                        ...
                                        />
                                        <div className="flex items-start text-sm text-blue-700 bg-gray-50 p-4 rounded-xl border-l-4 border-blue-500">
                                            <svg className="w-5 h-5 mr-3 flex-shrink-0 mt-0.5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                            ...
                            <div className="space-y-6">
                                <div className="bg-white rounded-md p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                    <div className="flex items-center mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-semibold text-slate-900 mb-1">Récapitulatif</h2>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div className="p-5 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                                                <div className="flex items-center mb-2">
                                                    <svg className="w-5 h-5 mr-2 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                                                    </svg>
                                                    <p className="text-xs font-medium text-blue-700 tracking-wider">Durée</p>
                                                </div>
                                                <p className="text-2xl font-semibold text-blue-700">{numberOfNights} {numberOfNights === 1 ? 'nuit' : 'nuits'}</p>
                                            </div>
                                            <div className="p-5 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                                                <div className="flex items-center mb-2">
                                                    <svg className="w-5 h-5 mr-2 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                                    </svg>
                                                    <p className="text-xs font-medium text-purple-700 tracking-wider">Voyageurs</p>
                                                </div>
                                                <p className="text-2xl font-semibold text-purple-700">{numberOfGuests} {numberOfGuests === 1 ? 'personne' : 'personnes'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    <p className="text-xs font-medium text-purple-700 tracking-wider mb-1">Nom complet</p>
                                                    <p className="text-xl font-semibold text-slate-900">{mainClient.firstName} {mainClient.lastName}</p>
                                                </div>
                                                <div>
                                                    <p className="text-xs font-medium text-purple-700 tracking-wider mb-1">Email</p>
                                                    <p className="text-lg font-semibold text-slate-700">{mainClient.email}</p>
                                                </div>
                                                <div>
                                                    <p className="text-xs font-medium text-purple-700 tracking-wider mb-1">Téléphone</p>
                                    ...
                                    {specialRequests && (
                                        <div>
                                            ...
                                            <div className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                                    ...
                                    <div className="mt-6 p-5 bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-500 rounded-lg">
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                <p className="text-sm font-semibold text-amber-900 mb-2">Avant de confirmer</p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 gap-4">
                            {currentStep > 1 && (
                                <button
                                    ...
                                    className="w-full sm:w-auto px-8 py-4 border-3 border-slate-300 text-slate-700 rounded-xl hover:bg-slate-100 hover:border-slate-400 transition-all duration-200 font-semibold text-lg flex items-center justify-center space-x-3 shadow-md hover:shadow-sm transform hover:scale-105"
                                >
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
