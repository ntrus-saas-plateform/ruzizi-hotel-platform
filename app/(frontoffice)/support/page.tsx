    ...
    <div className="min-h-screen bg-gradient-subtle pt-48 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="w-16 h-16 bg-gradient-to-br from-green-200 to-green-200 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            <h3 className="text-2xl font-bold text-luxury-dark mb-3">{t.phoneSupport}</h3>
            <p className="text-luxury-text mb-4 leading-relaxed">{t.phoneSupportDesc}</p>
            <p className="text-green-700 font-bold text-lg">+257 69 65 75 54</p>
            <p className="text-sm text-luxury-text mt-2 flex items-center">
          ...
          >
            <div className="w-16 h-16 bg-gradient-to-br from-blue-200 to-blue-200 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8 text-luxury-cream" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-luxury-dark mb-3">{t.emailSupport}</h3>
            <p className="text-luxury-text mb-4 leading-relaxed">{t.emailSupportDesc}</p>
          ...
          >
            <div className="w-16 h-16 bg-gradient-to-br from-purple-200 to-purple-200 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8 text-luxury-cream" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-luxury-dark mb-3">{t.faq}</h3>
            <p className="text-luxury-text mb-4 leading-relaxed">{t.faqDesc}</p>
        ...
        <div className="p-8 lg:p-12 mb-12">
          <div className="flex items-center justify-center mb-8">
            <h2 className="text-3xl font-bold text-luxury-dark">{t.howCanWeHelp}</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl hover:from-amber-100 hover:to-orange-100 transition-all duration-200">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-bold text-luxury-dark mb-2">{t.bookings}</h3>
                  <p className="text-luxury-text leading-relaxed">{t.bookingsDesc}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl hover:from-blue-100 hover:to-indigo-100 transition-all duration-200">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-bold text-luxury-dark mb-2">{t.technicalIssues}</h3>
                  <p className="text-luxury-text leading-relaxed">{t.technicalIssuesDesc}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl hover:from-red-100 hover:to-pink-100 transition-all duration-200">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-red-200 to-red-200 rounded-lg flex items-center justify-center mr-4">
                  <svg className="w-5 h-5 text-luxury-cream" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-luxury-dark mb-2">{t.complaints}</h3>
                  <p className="text-luxury-text leading-relaxed">{t.complaintsDesc}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl hover:from-green-100 hover:to-emerald-100 transition-all duration-200">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-bold text-luxury-dark mb-2">{t.suggestions}</h3>
                  <p className="text-luxury-text leading-relaxed">{t.suggestionsDesc}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0 md:mr-8">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-red-200 to-red-200 rounded-full flex items-center justify-center mr-4 animate-pulse">
                  <svg className="w-6 h-6 text-luxury-cream" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-luxury-dark">{t.emergency}</h3>
              </div>
              <p className="text-luxury-text text-lg leading-relaxed max-w-2xl">
                {t.emergencyDesc}
              </p>
            </div>
            <a
              href="tel:+25769657554"
              className="flex-shrink-0 px-8 py-4 bg-gradient-to-r from-red-500 to-red-600 text-luxury-cream font-bold rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center"
            >
