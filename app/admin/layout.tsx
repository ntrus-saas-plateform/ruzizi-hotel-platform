...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-luxury-text">Vérification de l'authentification...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Top Navigation Bar */}
      <nav className="bg-[hsl(30,21%,85%)] text-luxury-dark border-b border-gray-200 fixed w-full z-30 top-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <button
                ...
                className="lg:hidden px-4 py-2 text-luxury-dark rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
              >
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                onClick={() => router.push('/')}
                className="hidden md:flex items-center px-3 py-2 text-sm text-luxury-text hover:bg-gray-50 rounded-lg transition"
              >
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 p-2 text-sm bg-gray-50 rounded-lg hover:bg-gray-100 transition"
                >
                  <div className="w-8 h-8 bg-gradient-luxury rounded-full flex items-center justify-center">
                    <span className="text-luxury-cream font-semibold text-sm">A</span>
                  </div>
                  <svg
                    className="w-4 h-4 text-luxury-text hidden sm:block"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-52 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-200">
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-sm text-luxury-dark hover:bg-gray-100 flex items-center"
                    >
                      <svg
      ...
      <aside
        id="mobile-sidebar"
        className={`fixed flex flex-col top-0 left-0 z-40 w-64 h-screen transition-transform bg-luxury-dark ${
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        } lg:translate-x-0`}
      >
        {/* Logo */}
        <div className="flex items-center justify-center space-x-3 group rounded-lg py-2">
          <div className="relative">
          ...
          <div className="flex flex-col">
            ...
            <span className={`text-xs text-center -mt-1 font-light text-luxury-cream`}>
              Excellence & Confort
            </span>
          </div>
        </div>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center p-2 rounded-lg transition-colors ${
                      isActive
                        ...
                        : 'text-luxury-cream hover:text-[hsl(var(--color-luxury-dark))] hover:bg-[hsl(var(--color-luxury-gold))]'
                    }`}
                  >
                    <span
                      className={
                        isActive
                          ...
                          : 'text-[hsl(var(--color-luxury-cream))]/70'
                      }
                    >
                      {item.icon}
                    </span>
