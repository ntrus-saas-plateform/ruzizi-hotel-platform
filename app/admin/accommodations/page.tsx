      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-luxury-dark">Hébergements</h1>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 space-y-4 sm:space-y-0">
          <div className="flex items-center space-x-4">
            <div className="text-sm text-luxury-text">
              <span className="font-semibold text-luxury-dark">{accommodations.length}</span> hébergement(s)
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-luxury-text text-lg font-medium">Aucun hébergement trouvé</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {accommodations.map((accommodation: AccommodationResponse) => (
              ...
              >
                ...
                {/* Content */}
                <div className="p-5">
                  <h3 className="text-lg font-bold text-luxury-dark mb-3">
                    {accommodation.name}
                  </h3>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4 p-3 bg-gray-50 rounded-lg">
                    <div className="text-center">
                      ...
                      <div className="text-sm font-semibold text-luxury-dark">{accommodation.capacity.maxGuests}</div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm font-semibold text-luxury-dark">{accommodation.capacity.bedrooms}</div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm font-semibold text-luxury-dark">{accommodation.capacity.bathrooms}</div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <h3 className="font-bold text-luxury-dark text-xl">{accommodation.name}</h3>
