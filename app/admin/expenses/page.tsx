      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-luxury-text mt-2">
                Suivre et gérer toutes les dépenses de la plateforme
              </p>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-sm text-luxury-text mb-1">Total Dépenses</p>
            <p className="text-2xl font-bold text-luxury-dark">{totalExpenses}</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-sm text-luxury-text mb-1">Approuvées</p>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-sm text-luxury-text mb-1">En Attente</p>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-sm text-luxury-text mb-1">Montant Total</p>
            <p className="text-2xl font-bold text-purple-600">
              {calculateTotalAmount().toLocaleString()} BIF
            </p>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 mb-8">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 ${showFilters ? 'block' : 'hidden md:grid'}`}
          >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setFilters((prev) => ({ ...prev, establishmentId: e.target.value }))
                }
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm appearance-none"
              >
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full px-4 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:border-blue-500 hover:text-luxury-gold transition-all duration-200 font-medium flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden">
          {loading ? (
            <div className="p-12 text-center">
              ...
              <p className="mt-6 text-lg text-luxury-text font-medium">
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-xl font-bold text-luxury-dark mb-2">Aucune dépense trouvée</h3>
              <p className="text-luxury-text mb-6">Essayez de modifier vos critères de recherche</p>
              <button
                onClick={() =>
                  setFilters({
                    search: '',
                ...
                className="px-6 py-3 bg-luxury-gold text-luxury-cream rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl font-medium"
              >
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {expenses.map((expense) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-luxury-dark flex items-center">
                            <svg
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-bold text-luxury-dark">
                            {expense.amount.toLocaleString()} BIF
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${getStatusColor(expense.status)}`}
                          >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          <button
                            ...
                            className="text-luxury-gold hover:text-blue-900 font-medium flex items-center"
                          >
                            <svg
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <h3 className="text-sm font-bold text-luxury-dark mb-2">
                          {expense.description}
                        </h3>
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center text-sm font-bold text-luxury-dark">
                        <svg
                          className="w-4 h-4 mr-2"
                          fill="none"
                          stroke="currentColor"
                    ...
                    <button
                      onClick={() => router.push(`/admin/expenses/${expense.id}`)}
                      className="w-full px-4 py-2 bg-luxury-gold text-luxury-cream rounded-lg  transition-colors font-medium flex items-center justify-center"
                    >
                      <svg
                        className="w-4 h-4 mr-2"
                        fill="none"
                ...
                <div className="bg-gradient-to-r from-gray-50 to-blue-50 px-6 py-4 flex flex-col sm:flex-row items-center justify-between border-t gap-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 border-2 border-gray-300 rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:border-blue-500 hover:text-luxury-gold transition-all duration-200 flex items-center"
                    >
                      <svg
                        className="w-4 h-4 mr-1"
                        fill="none"
