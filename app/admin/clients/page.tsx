      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-luxury-dark">Clients</h1>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 space-y-4 sm:space-y-0">
          <div className="flex items-center space-x-4">
            <div className="text-sm text-luxury-text">
              <span className="font-semibold text-luxury-dark">{clients.length}</span> client(s)
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-luxury-text text-lg font-medium">Aucun client trouvé</p>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <div className="w-12 h-12 bg-gradient-luxury rounded-full flex items-center justify-center text-luxury-cream font-bold text-lg">
                        {client.firstName?.charAt(0)}{client.lastName?.charAt(0)}
                      </div>
                      <div>
                        <h3 className="font-bold text-luxury-dark">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4 p-3 bg-gray-50 rounded-lg">
                    <div className="text-center">
                      <div className="text-lg font-bold text-luxury-gold">{client.totalBookings || 0}</div>
                  ...
                  {clients.map((client) => (
                    <tr key={client.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-gradient-luxury rounded-full flex items-center justify-center text-luxury-cream font-bold text-sm mr-3">
                            {client.firstName?.charAt(0)}{client.lastName?.charAt(0)}
                          </div>
                          <div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-luxury-dark">{client.email}</div>
                        <div className="text-sm text-gray-500">{client.phone}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-luxury-dark">{client.nationality}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-luxury-dark">{getCustomerTypeLabel(client.customerType)}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-luxury-dark">{client.totalBookings || 0}</div>
                      </td>
