    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <header className="mb-6">
          ...
          <p className="text-gray-600 mt-2 text-sm sm:text-base">Vue d'ensemble des réservations et de l'occupation</p>
        </header>
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6" aria-labelledby="date-range-heading">
          <h2 id="date-range-heading" className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Période</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex items-end sm:col-span-2 lg:col-span-1">
              <button
                ...
                className="w-full px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-md hover:shadow-lg font-medium flex items-center justify-center focus:outline-none focus:ring-4 focus:ring-blue-500/50 touch-manipulation min-h-[44px]"
        ...
        {loading ? (
          ...
          <>
            ...
            <section className="bg-white rounded-lg shadow p-6 mb-6" aria-labelledby="global-occupancy-heading">
              <h2 id="global-occupancy-heading" className="text-lg font-semibold text-gray-900 mb-4">
            ...
            <section className="bg-white rounded-lg shadow p-6" aria-labelledby="occupancy-by-type-heading">
              <h2 id="occupancy-by-type-heading" className="text-lg font-semibold text-gray-900 mb-4">
              ...
              <article className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 mt-1" aria-label="Nombre de réservations actives">-</p>
                  </div>
              ...
              <article className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 mt-1" aria-label="Nombre d'arrivées aujourd'hui">-</p>
                  </div>
              ...
              <article className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 mt-1" aria-label="Nombre de départs aujourd'hui">-</p>
                  </div>
