  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-luxury-dark">Modifier la Réservation</h1>
        <p className="text-luxury-text mt-2">Mettre à jour les informations de la réservation</p>
      </div>
