        ...
        <div className="p-6 max-w-6xl mx-auto">
            <div className="mb-6">
                ...
                <div className="flex items-start justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-luxury-dark">{establishment.name}</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-luxury-dark capitalize">{establishment.type}</p>
                            </div>

                            <div>
                                <label className="text-sm font-medium text-gray-500">Description</label>
                                <p className="text-luxury-dark">{establishment.description || 'Aucune description'}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-luxury-dark">{establishment.contacts?.phone || 'N/A'}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-gray-500">Email</label>
                                    <p className="text-luxury-dark">{establishment.contacts?.email || 'N/A'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {establishment.amenities && establishment.amenities.length > 0 && (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <h2 className="text-xl font-bold text-luxury-dark mb-4">Équipements et services</h2>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-blue-50 rounded-lg">
                                <div className="text-2xl font-bold text-luxury-gold">{establishment.totalCapacity || 0}</div>
                                <div className="text-sm text-luxury-text">Capacité totale</div>
                            </div>
                            ...
                            <div className="p-4 bg-purple-50 rounded-lg">
                                ...
                                <div className="text-sm text-luxury-text">Mode de tarification</div>
                            </div>
                            ...
                            <div className="p-4 bg-green-50 rounded-lg">
                                ...
                                <div className="text-sm text-luxury-text">Statut</div>
                            </div>
                        </div>
                    </div>
