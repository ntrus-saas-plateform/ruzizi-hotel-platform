  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-luxury-dark">Modifier l'Établissement</h1>
        <p className="text-luxury-text mt-2">Mettre à jour les informations de l'établissement</p>
      </div>
